<?php   
        ...
        include('../private/request_handlers/scripts/edit_account.put.php');
        ?>
<!DOCTYPE html>
<html lang="en">
        ...
        <section id="body" class="body" style="margin-top: 5%;">
            <section id="body_container" class="body_container" style="margin: auto;margin-top: 0%;">
                ...
                <div id="page_name" class="page_name" style="text-align: center;font-size: 11px;">
                    <h5 style="font-size: 16px;font-weight: bold;">Account</h5>
                    <?php echo $dialogue_2 ?>
                </div>
                <div id="form" class="form">
                    <form method="POST" action="<?php echo $host ?>/UI/account/?token=<?php echo $token?>">
                        <input type="hidden" name="u_id" value="<?php echo $u_id ?>">
                        <p style="margin-bottom: 0;">Personal</p>
                        <div class="input-group"><span class="input-group-text" style="font-size: 11px;width: 95px;">Name</span><input class="form-control" name="name" type="text" value="<?php echo $u_name ?>" required></div>
                        <button class="btn btn-primary float-end" style="background-color:black" name="edit_user" type="submit">Submit</button>
                    </form>

                    <form method="POST" action="<?php echo $host ?>/UI/account/?token=<?php echo $token?>">
                    <input type="hidden" name="u_id" value="<?php echo $u_id ?>">
                        <p style="margin-bottom: 0;margin-top: 17px;">Password</p>
                        <div class="input-group"><span class="input-group-text" style="width: 95px;font-size: 11px;">Old Password</span><input class="form-control" name="old_password" type="password"  autocomplete="off" required></div>
                        <div class="input-group"><span class="input-group-text" style="font-size: 11px;width: 95px;">New Password</span><input class="form-control" name="password_1" type="password"  autocomplete="off" required></div>
                        <div class="input-group"><span class="input-group-text" style="font-size: 11px;width: 95px;">Confirm&nbsp;</span><input class="form-control" name="password_2" type="password"  autocomplete="off" required></div>
                        <button class="btn btn-primary float-end" style="background-color:black" name="new_password" type="submit">Submit</button>
                    </form>
                </div>
            </section>
        </section>
