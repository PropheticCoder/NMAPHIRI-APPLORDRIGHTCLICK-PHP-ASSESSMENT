<?php   
        ...
        include('../private/request_handlers/scripts/get_task.get.php');
        include('../private/request_handlers/scripts/edit_task.put.php');
        ?>
<!DOCTYPE html>
<html lang="en">
        ...
        <section id="body" class="body" style="margin-top: 5%;">
            <section id="body_container" class="body_container" style="margin: auto;margin-top: 0%;">
                ...
                <div id="page_name" class="page_name" style="text-align: center;font-size: 11px;">
                    <h5 style="font-size: 16px;font-weight: bold;">Edit Task</h5>
                    <?php echo $dialogue ?>
                </div>
                <div id="form" class="form">
                    <form method="POST" action="<?php echo $host ?>/UI/edit_task/?token=<?php echo $token?>">
                        <input type="hidden" name="u_id" value="<?php echo $u_id ?>">
                        <input type="hidden" name="task_id" value="<?php echo $task_id ?>">
                        <div class="input-group"><span class="input-group-text" style="width: 95px;font-size: 11px;">Task Name</span><input class="form-control" name="task_name" type="text" value="<?php echo $task_name ?>" required=""></div>
                        <div class="input-group"><span class="input-group-text" style="font-size: 11px;width: 95px;">Description</span><input class="form-control" name="description" type="text" value="<?php echo $description ?>"></div>
                        <div class="input-group"><span class="input-group-text" style="font-size: 11px;width: 95px;">Competed</span>
                        <select class="form-select" name="Complete" required="">
                                <?php echo $completed_html ?>
                        </select>
                        </div>
                        <div class="input-group"><span class="input-group-text" style="font-size: 11px;width: 95px;">Due</span><input class="form-control" name="due" type="datetime-local" value="<?php echo $due ?>" required=""></div>
                        <button class="btn btn-primary float-end" style="background-color:black" name="submit_edit_task" type="submit">Edit Task</button>
                    </form>
                </div>
            </section>
        </section>
